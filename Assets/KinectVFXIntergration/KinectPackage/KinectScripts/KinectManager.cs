...
//				}
				...
				Debug.Log("Adding user " + uidIndex + ", ID: " + userId + ", Body: " + bodyIndex + ", PlayerCount: " + PlayerNumber);
	...
	private void RemoveUser(Int64 userId)
	{
		...
		Debug.Log ("Removing user " + uidIndex + ", ID: " + userId + ", Body: " + dictUserIdToIndex [userId] + ", PlayerCount: " + PlayerNumber);
