...
public class StarEX: MonoBehaviour {
    
    public ColorPoint center1;
    public ColorPoint center2;
    public ColorPoint center3;
    ...
    public void UpdateMesh () {
        ...
        if (vertices == null || vertices.Length != numberOfPoints + 1) {
            vertices = new Vector3[numberOfPoints * 3 + 1];
        ...
        if (numberOfPoints >= 3) {
            vertices[0] = center1.position;
            colors[0] = center1.color;
